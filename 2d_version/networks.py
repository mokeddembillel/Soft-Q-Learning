...
class ActionValueNetwork(nn.Module):
    def __init__(self, beta, state_dim, action_dim, n_particles, fc1_dims=256, fc2_dims=256,
        ...
        self.fc1_dim = self.state_dim + self.action_dim * self.n_particles
        self.fc2_dim = 128
        self.fc3_dim = self.n_particles
...
class SamplerNetwork(nn.Module):
    def __init__(self, alpha, state_dim, n_particles,
        ...
        # Initialize Input dimentions
        self.fc1_dim = self.state_dim + self.n_particles * self.action_dim
        self.fc2_dim = 512
        self.fc3_dim = 512
        self.fc4_dim = 512
        self.fc5_dim = self.n_particles * self.action_dim
...
#             fc2_dims=256, n_actions=2, name='Sampler', chkpt_dir='tmp/sql'):
#         super(SamplerNetwork, self).__init__()
